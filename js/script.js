...
while (diffLvl < 0 || diffLvl > 2 || isNaN(diffLvl)) { //checking if the user is entering valid input
  ...
  if (diffLvl < 0) {
    alert('You cannot enter a number lower than 0');
  } else if (diffLvl > 2) {
    alert('You cannot enter a number higher than 2')
...
if (userList.length <= 5) {
  alert('Puah! You suck! Your score is: ' + parseInt(userList.length)  + ' points');
